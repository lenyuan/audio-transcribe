  ...
  return (
    <div className="space-y-4">
      {segments.map((segment, index) => (
        <div key={index} className="flex flex-col sm:flex-row gap-4 p-4 bg-slate-800/60 rounded-lg border border-slate-700 shadow-md transition-all duration-300 hover:border-sky-700 hover:shadow-sky-900/30 relative group">
          ...
          <div className="flex-1 text-slate-300 leading-relaxed">
           ...
           <button 
            ...
            className="absolute top-2 right-2 p-1.5 rounded-full bg-slate-700/50 text-slate-400 opacity-0 group-hover:opacity-100 focus:opacity-100 transition-all duration-300 hover:bg-slate-600 hover:text-sky-300"
